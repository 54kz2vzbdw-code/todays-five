...
| the 18 kits and the 13 font pairs (1.12 b212) | `test/fixtures/kits.json` | `test/tools/gen-kits.mjs` |
| the Watch's real family and PostScript names (1.12 b212) | `test/fixtures/watch-fonts.json` + `apple/TodaysFive/Fonts/*.ttf` | `apple/tools/gen-watch-fonts.py` |
...
| `Vault.swift`, `WatchLink.swift` | what the phone holds, and what crosses to the wrist (links, and since 1.12 b212 the two Secret kits) |
...
Since 1.12 b212 that comparison is **geometry**, which is what it always claimed to be: both images are
