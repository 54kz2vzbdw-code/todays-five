...
| `Vault.swift`, `WatchLink.swift` | what the phone holds, and what crosses to the wrist (links, and since 1.12 b216 the two Secret kits) |
...
Since 1.12 b216 that comparison is **geometry**, which is what it always claimed to be: both images are
