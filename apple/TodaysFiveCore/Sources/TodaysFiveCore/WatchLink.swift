...
//
// 1.12 b207 adds one thing to that, and it is a palette rather than a list: the two **Secret kits**, which
...
public struct WatchLinkPayload: Sendable, Equatable {
    ...
    /// own: a build that predates 1.12 b207 keeps unknown keys and hands them back, so a Watch on an
