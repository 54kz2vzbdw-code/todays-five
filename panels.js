...
const PANELS_BUILD = 207; // the build whose markup this module wires; stamped with version.js, checked by test/features.test.js
...
/** The saved themes this device may see. 1.12 b207: a themes record's `code` is a theme code like any
...
function renderSwatches() {
  ...
  const saved = savedThemes();   // 1.12 b207: already gated — see savedThemes()
  const mk = (t, rec) => {
