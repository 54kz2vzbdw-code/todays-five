...
// new/ (67f35a5) side by side on 8895, so both paths share localStorage the way one origin does across a deploy.
import { launch, context, freshPage, s, meta, wait, esc, openListsDetail, openMore, log } from "./lib.mjs";
const OLD = "http://127.0.0.1:8895/old/", NEW = "http://127.0.0.1:8895/new/";
