...
/** The floors every kit clears **on its own grounds** — which is the point of the round: until 1.12 b216
...
const FLOORS = [
  ...
  ["done2",      "ink3", 4.5],
  ["accent",     "ink",  3],
  ["accent",     "ink3", 3],     // 1.7 added this to finalize(); 1.12 b216 makes every reader check it
  ["accentText", "ink",  4.5],
  ["accentText", "ink3", 4.5],
  ["hairSolid",  "ink",  3],
  ["danger",     "ink",  4.5],
