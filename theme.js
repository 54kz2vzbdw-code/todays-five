...
/* ---------------- the brand (1.11), and the accent unpinned from it (1.12 b212) ----------------
   ...
   1.11 then took one step past the mark, and 1.12 b212 takes that step back. Having found a hex that
   ...
   **The premise was wrong, not the sum.** Nothing ever required the two default kits to share an
   ...
   not as a brand. So since 1.12 b212 **every kit carries its own accent family**: Paper's #C8321F and
   ...
   **The mark does not move.** `BRAND_ACCENT` is still #A86014, and so are `icons/mark.svg`,
   ...
   is what 1.12 b212 trades away, knowingly. One kit still carries #A86014 — Dark, where it is that kit's
...
/** #A86014 — hue 60, the balanced warm. Balancing for the best *weakest* contrast pins any accent
    ...
    Since 1.12 b212 this is the mark's colour and Dark's, and no longer Paper's or Terminal's UI accent
...
/* 1.12 b212: `brandAccentSet(base)` stood here — the accent family 1.11 spread over Paper and Terminal.
...
const RAW = [
  ...
  kit("light", "Light", "light", "lato", {
    ...
    // 1.12 b212: danger was #B8402A, which is 4.12:1 on this kit's --ink-3 — under 4.5. Light is exempt
  ...
  kit("paper", "Paper", "light", "playfair", {
    ...
    // 1.12 b212: the red pencil is Paper's own again, byte for byte the family it carried before 1.11
  ...
  kit("terminal", "Terminal", "dark", "mono", {
    ...
    // 1.12 b212: the phosphor green is Terminal's own again, byte for byte the family it carried before 1.11
...
/** Contrast report used by tests and the picker's preview.
    1.12 b212: `accent3` and `danger3` join it — the accent and the danger colour against `--ink-3`, the
